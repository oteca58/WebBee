...
router
  ...
  .post(authController.protect, authController.restrictTo("admin", "beekeeper"), beehiveController.createBeehive);

router
  .route("/:id")
  .get(authController.protect, beehiveController.getBeehive)
  .patch(authController.protect, authController.restrictTo("admin", "beekeeper"), beehiveController.updateBeehive)
